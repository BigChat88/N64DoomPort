...
void S_ChangeMusic(int musicnum, int looping)
{
    ...
    // register it - I_RegisterSong now loads the pre-rendered rom:/mus/
    // D_<NAME>.wav64 itself (see i_sound.c), so the WAD's raw MUS lump is
    // never cached here any more.
