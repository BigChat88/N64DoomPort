...
// Time sucks.
// Named timepatch, not time - a newer libdragon toolchain update started
// pulling in <time.h>'s time() declaration here (via rtc.h/libdragon.h),
// which collided with this file-scope variable of the same name.
